...
void playerb::updateMovement(int postac)
{
	if (postac == 0) {
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && !animating && !animating2 && !animating3 && !animating4 && sprite.getPosition().x >= 0)
		{
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right) && !animating && !animating2 && !animating3 && !animating4 && sprite.getPosition().x <= 550)
		{
			rect.move(movementSpeed, 0);
			rect.setSize(sf::Vector2f(63, 95));
...
void playerb::updateMovementR(int postac)
{
	if (postac == 0) {
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left) && !animating && !animating2 && !animating3 && !animating4 && sprite.getPosition().x >= 0)
		{
